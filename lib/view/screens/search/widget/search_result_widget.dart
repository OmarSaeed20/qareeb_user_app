...
class SearchResultWidgetState extends State<SearchResultWidget>
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      GetBuilder<SearchControllerx>(builder: (searchController) {
        bool isNull = true;
        int length = 0;
                            ...
                            ? InkWell(
                                onTap: () {
                                  ...
                                  Get.dialog(FilterWidget(
                                      maxValue: maxValue,
                                      isStore: Get.find<SearchControllerx>()
                                          .isStore));
                                },
      ...
      Expanded(
        ...
        onNotification: (dynamic scrollNotification) {
          if (scrollNotification is ScrollEndNotification) {
            Get.find<SearchControllerx>().setStore(_tabController!.index == 1);
            Get.find<SearchControllerx>().searchData(widget.searchText, false);
          }
          return false;
        },
        child: TabBarView(
